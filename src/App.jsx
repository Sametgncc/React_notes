...
// import Clock2 from "./components/06-clock1/clock2";
...
const App = () => {
  return (
    ...
    <Greetings></Greetings>
    <Products></Products>
    <Clock2 textColor="red" bground="yellow"></Clock2>
    <Clock2 textColor="white" bground="black"></Clock2>
    <Clock2 textColor="yellow" bground="darkblue" hideTime = {false} ></Clock2>
    <Image></Image>
   <Gallery></Gallery>
